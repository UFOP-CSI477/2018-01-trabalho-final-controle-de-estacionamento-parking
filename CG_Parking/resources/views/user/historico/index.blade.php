...
@section('title', 'Histórico CG Parking')

@section('content_header')
<h1><strong>HISTÓRICO DE USO DO CG PARKING</strong></h1>
<ol class="breadcrumb">
    <li><a href="{{ route('home.home') }}"><strong>Home</strong></a></li>
    <li><a href="{{ route('historico.index') }}"><strong>Histórico</strong></a></li>
</ol>
@stop

@section('content')
<form method="POST" action="{{ route('historico.show') }}">
     {!! csrf_field ()!!}
<div class="row">
        <div class="col-xs-12">
