...
<div class="box box-solid box-info">
    <div class="box-header with-border">
        <h1 class="box-title"><strong>Perfil do Usuário</strong></h1>
    </div>
<!-- /.box-header -->
    <div class="box-body">
    ...
    <!-- /.box-body -->
    <div class="box-foot">
        <button type="button" style="width:250px"class="btn bg-purple margin" onclick="window.location='{{ route('uuuser.editt') }}'">Editar - <i class="fa fa-edit"></i></button>
    </div>
</div>
