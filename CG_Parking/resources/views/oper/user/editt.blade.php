...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('uuser.showw') }}"><strong>Perfil</strong></a></li>
...
<div class="box box-solid box-info">
    <div class="box-header with-border">
        <h1 class="box-title"><strong>Editar Perfil do Operador</strong></h1>
    </div>
<!-- /.box-header -->
    <div class="box-body">
       <form role="form" method="POST" action="{{ route('uuser.updatee') }}">
            {!! csrf_field ()!!}
                <div class="box-body">
