...
<ol class="breadcrumb">
    ...
    <li><a href="{{ route('opervalor.index') }}"><strong>Valores</strong></a></li>
    <li><a href="{{ route('opervalor.index') }}"><strong>Visualizar</strong></a></li>
</ol>
@stop

@section('content')
<form method="POST" action="{{ route('opervalor.show') }}">
     {!! csrf_field ()!!}
<div class="row">
        <div class="col-xs-12">
