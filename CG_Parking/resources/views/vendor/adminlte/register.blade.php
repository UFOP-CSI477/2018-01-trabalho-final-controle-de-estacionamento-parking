    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="{{ url(config('adminlte.register_url', 'register')) }}" method="post">
                ...
                <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
                    <input type="text" maxlength="11" name="cpf" class="form-control" value="{{ old('name') }}"
                ...
                <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
                    <input type="text" name="endereco" class="form-control" value="{{ old('name') }}"
                ...
                <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
                    <input type="text" name="telefone" class="form-control" value="{{ old('name') }}"
